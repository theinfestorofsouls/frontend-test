...
import sty from "./PlasmicButton.module.css"; // plasmic-import: HBc8pQz6nAL/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: N2OXTT08ze5/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: HejyhsW9qWE/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4XBoV)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__gogvl)}
                role={"img"}
              />
            ),
